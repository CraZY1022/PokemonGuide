...
exports.MOCK_POKEMON_LIST = void 0;
const pokemon_types_1 = require("../constants/pokemon-types");
exports.MOCK_POKEMON_LIST = [
    {
        id: 1,
        nameZh: '妙蛙种子',
        nameEn: 'Bulbasaur',
        types: [pokemon_types_1.PokemonType.Grass, pokemon_types_1.PokemonType.Poison],
    ...
    },
    {
        ...
        nameZh: '小火龙',
        nameEn: 'Charmander',
        types: [pokemon_types_1.PokemonType.Fire],
    ...
    },
    {
        ...
        nameZh: '杰尼龟',
        nameEn: 'Squirtle',
        types: [pokemon_types_1.PokemonType.Water],
    ...
    },
    {
        ...
        nameZh: '皮卡丘',
        nameEn: 'Pikachu',
        types: [pokemon_types_1.PokemonType.Electric],
    ...
    },
    {
        ...
        nameZh: '百变怪',
        nameEn: 'Ditto',
        types: [pokemon_types_1.PokemonType.Normal],
    ...
    },
    {
        ...
        nameZh: '快龙',
        nameEn: 'Dragonite',
        types: [pokemon_types_1.PokemonType.Dragon, pokemon_types_1.PokemonType.Flying],
    ...
    },
    {
        ...
        nameZh: '梦幻',
        nameEn: 'Mew',
        types: [pokemon_types_1.PokemonType.Psychic],
